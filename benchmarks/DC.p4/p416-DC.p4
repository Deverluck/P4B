...
@name(".ecmp_action_profile") action_selector(HashAlgorithm.crc16, 32w512, 32w10) ecmp_action_profile;

@name(".lag_action_profile") action_selector(HashAlgorithm.crc16, 32w512, 32w8) lag_action_profile;
