...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".calc_modulo") action calc_modulo() {
        hash(meta.hash_metadata.mplb_hash_modulo, HashAlgorithm.crc32, (bit<32>)0, { hdr.ipv4.protocol, hdr.tcp.dstPort, hdr.tcp.srcPort }, (bit<64>)1000);
    }
    @name(".set_dst") action set_dst(bit<32> dst, bit<32> pdip, bit<32> ts) {
        ...
        hdr.mplb_ipopt.len = 8w12;
        hdr.ipv4.ihl = 4w8;
        hdr.ipv4.totalLen = hdr.ipv4.totalLen + 16w32;
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        update_checksum(true, { hdr.ipv4.protocol, hdr.tcp.dstPort, hdr.tcp.srcPort }, meta.hash_metadata.mplb_hash, HashAlgorithm.crc32);
