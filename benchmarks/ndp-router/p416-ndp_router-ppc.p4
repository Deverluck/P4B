...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".decreasereg") action decreasereg() {
        ...
        meta.meta.register_tmp = meta.meta.register_tmp - 16w1;
        meta.meta.register_tmp = meta.meta.register_tmp + meta.meta.egress_priority;
        buffersense.write((bit<32>)standard_metadata.egress_port, (bit<16>)meta.meta.register_tmp);
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".directpriohigh") action directpriohigh() {
        meta.meta.egress_priority = 16w1;
    ...
    @name(".setpriolow") action setpriolow() {
        meta.meta.egress_priority = 16w0;
        buffersense.read(meta.meta.register_tmp, (bit<32>)standard_metadata.egress_port);
        meta.meta.register_tmp = meta.meta.register_tmp + 16w1;
        buffersense.write((bit<32>)standard_metadata.egress_port, (bit<16>)meta.meta.register_tmp);
    }
    @name(".setpriohigh") action setpriohigh() {
        truncate((bit<32>)32w67);
        meta.meta.egress_priority = 16w1;
    }
